...
/**
 * V2 Event Detail Endpoints
 * Callback URLs for Ndilius to query event details
 */
@RestController
...
class EventV2Resource(
  ...
  @Operation(
    ...
    description = "Callback URL for Ndilius to query formatted notes for setup completed event",
  )
  @PreAuthorize("hasRole('ROLE_ESUPERVISION__CHECK_IN__RO')")
  fun getSetupCompletedEvent(
    @Parameter(description = "Offender UUID", required = true)
    @PathVariable uuid: UUID,
  ): ResponseEntity<EventDetailResponse> {
    val detailUrl = "/v2/events/setup-completed/$uuid"
    val event = notificationService.getEventDetail(detailUrl)
  ...
  @Operation(
    ...
    description = "Callback URL for Ndilius to query formatted notes for checkin created event",
  )
  @PreAuthorize("hasRole('ROLE_ESUPERVISION__CHECK_IN__RO')")
  ...
  @Operation(
    ...
    description = "Callback URL for Ndilius to query formatted notes for checkin submitted event",
  )
  @PreAuthorize("hasRole('ROLE_ESUPERVISION__CHECK_IN__RO')")
  ...
  @Operation(
    ...
    description = "Callback URL for Ndilius to query formatted notes for checkin reviewed event",
  )
  @PreAuthorize("hasRole('ROLE_ESUPERVISION__CHECK_IN__RO')")
  ...
  @Operation(
    ...
    description = "Callback URL for Ndilius to query formatted notes for checkin expired event",
  )
  @PreAuthorize("hasRole('ROLE_ESUPERVISION__CHECK_IN__RO')")
