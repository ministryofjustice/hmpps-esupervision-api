...
/**
 * V2 Offender Setup Resource
 * REST endpoints for V2 registration/setup workflow
 */
@RestController
...
class OffenderSetupV2Resource(
  ...
  @Operation(
    ...
    description = """Start the setup (registration) process for a V2 offender.
  ...
  @Operation(
    ...
    description = """Request a presigned S3 URL for uploading the offender's photo.
  ...
  @Operation(
    ...
    description = """Complete the setup process for a V2 offender.
  ...
  fun completeSetup(@PathVariable uuid: UUID): ResponseEntity<OffenderV2Dto> {
    ...
    LOGGER.info("Completed V2 setup: setupUuid={}, offenderUuid={}, crn={}", uuid, offender.uuid, offender.crn)
  ...
  @Operation(
    ...
    description = """Cancel/terminate the setup process for a V2 offender.
  ...
  fun terminateSetup(@PathVariable uuid: UUID): ResponseEntity<OffenderV2Dto> {
    ...
    LOGGER.info("Terminated V2 setup: setupUuid={}, offenderUuid={}, crn={}", uuid, offender.uuid, offender.crn)
