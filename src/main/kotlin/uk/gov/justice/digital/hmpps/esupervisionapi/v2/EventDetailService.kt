...
class EventDetailService(
  ...
  private fun formatCheckinNotes(checkin: OffenderCheckin, eventType: DomainEventType, logEntry: IOffenderCheckinLogEntryDto? = null): String {
  ...
  companion object {
    private val LOGGER = logger<EventDetailService>()
  }
}
